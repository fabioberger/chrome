...
func (p *PageAction) SetTitle(details map[string]interface{}) {
	p.o.Call("setTitle", details)
}

// GetTitle gets the title of the page action.
func (p *PageAction) GetTitle(details map[string]interface{}, callback func(result string)) {
...
func (p *PageAction) SetIcon(details map[string]interface{}, callback func()) {
...
func (p *PageAction) SetPopup(details map[string]interface{}) {
	p.o.Call("setPopup", details)
}

// GetPopup gets the html document set as the popup for this page action.
func (p *PageAction) GetPopup(details map[string]interface{}, callback func(result string)) {
