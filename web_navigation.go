...
func (w *WebNavigation) OnBeforeNavigate(callback func(details map[string]interface{}), filters []map[string]interface{}) {
...
func (w *WebNavigation) OnCommited(callback func(details map[string]interface{}), filters []map[string]interface{}) {
...
func (w *WebNavigation) OnDOMContentLoaded(callback func(details map[string]interface{}), filters []map[string]interface{}) {
...
func (w *WebNavigation) OnCompleted(callback func(details map[string]interface{}), filters []map[string]interface{}) {
...
func (w *WebNavigation) OnErrorOccurred(callback func(details map[string]interface{}), filters []map[string]interface{}) {
...
func (w *WebNavigation) OnCreatedNavigationTarget(callback func(details map[string]interface{}), filters []map[string]interface{}) {
...
// use the updated URL.
func (w *WebNavigation) OnReferenceFragmentUpdated(callback func(details map[string]interface{}), filters []map[string]interface{}) {
...
func (w *WebNavigation) OnHistoryStateUpdated(callback func(details map[string]interface{}), filters []map[string]interface{}) {
