...
func (i *Identity) GetAuthToken(details map[string]interface{}, callback func(token string)) {
...
func (i *Identity) GetProfileUserInfo(callback func(userInfo map[string]interface{})) {
...
func (i *Identity) RemoveCacheAuthToken(details map[string]interface{}, callback func()) {
...
func (i *Identity) LaunchWebAuthFrom(details map[string]interface{}, callback func(response string)) {
