...
type FileSystemInfo struct {
	...
	OpenedFiles     []Object `js:"openedFiles"`
}
...
func (f *FileSystemProvider) Mount(options Object, callback func()) {
...
func (f *FileSystemProvider) Unmount(options Object, callback func()) {
...
func (f *FileSystemProvider) OnUnmountRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnGetMetadataRequested(callback func(options Object, successCallback func(metadata EntryMetadata), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnReadDirectoryRequested(callback func(options Object, successCallback func(entries []EntryMetadata, hasMore bool), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnOpenFileRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnCloseFileRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnReadFileRequested(callback func(options Object, successCallback func(data interface{}, hasMore bool), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnCreateDirectoryRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnDeleteEntryRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnCreateFileReqested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnCopyEntryRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
// then errorCallback must be called.
func (f *FileSystemProvider) OnMoveEntryRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
// then errorCallback must be called.
func (f *FileSystemProvider) OnTruncateRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnWriteFileRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
...
func (f *FileSystemProvider) OnAbortRequested(callback func(options Object, successCallback func(), errorCallback func(err string))) {
