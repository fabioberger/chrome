...
func (c *Cookies) Get(details map[string]interface{}, callback func(cookie Cookie)) {
...
func (c *Cookies) GetAll(details map[string]interface{}, callback func(cookies []Cookie)) {
...
func (c *Cookies) Set(details map[string]interface{}, callback func(cookie Cookie)) {
