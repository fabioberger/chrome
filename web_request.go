...
type BlockingResponse struct {
	...
	RequestHeaders  map[string]interface{} `js:"requestHeaders"`
	ResponseHeaders map[string]interface{} `js:"responseHeaders"`
...
func (w *WebRequest) OnBeforeRequest(callback func(details map[string]interface{})) {
...
func (w *WebRequest) OnBeforeSendHeaders(callback func(details map[string]interface{})) {
...
func (w *WebRequest) OnSendHeaders(callback func(details map[string]interface{})) {
...
func (w *WebRequest) OnHeadersReceived(callback func(details map[string]interface{})) {
...
func (w *WebRequest) OnAuthRequired(callback func(details map[string]interface{})) {
...
func (w *WebRequest) OnResponseStarted(callback func(details map[string]interface{})) {
...
func (w *WebRequest) OnBeforeRedirect(callback func(details map[string]interface{})) {
	w.o.Get("onBeforeRedirect").Call("addListener", callback)
}

// OnCompleted fired when a request is completed.
func (w *WebRequest) OnCompleted(callback func(details map[string]interface{})) {
	w.o.Get("onCompleted").Call("addListener", callback)
}

// OnErrorOccured fired when an error occurs.
func (w *WebRequest) OnErrorOccured(callback func(details map[string]interface{})) {
